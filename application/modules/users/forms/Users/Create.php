...
class Users_Form_Users_Create extends Core_Form
{
    ...
    protected function _role()
    {
        ...
        $element->addMultiOption(Users_Model_User::ROLE_GUEST, 'Guest');
        $element->addMultiOption(Users_Model_User::ROLE_USER, 'User');
        $element->addMultiOption(Users_Model_User::ROLE_MANAGER_OP, 'Manager_op');
        $element->addMultiOption(Users_Model_User::ROLE_MANAGER_OS, 'Manager_os');
        $element->addMultiOption(Users_Model_User::ROLE_MANAGER_OL, 'Manager_ol');
